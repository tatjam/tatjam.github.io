...
<input type="text" id="custom_name" placeholder="Default" name="custom_name" onchange="generate()">

<br>

<label for="custom_text">Custom Text: </label>
<textarea type="text" id="custom_text" placeholder="None" name="custom_text" onchange="generate()"></textarea>
...
<textarea type="text" id="hazard_text" placeholder="None" name="hazard_text" onchange="generate()"></textarea>
